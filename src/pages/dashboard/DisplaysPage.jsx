                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-12">
                    <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="space-y-1">
                        <div className="flex items-center gap-3">
                            ...
                            <Link 
                                to="/admin/configpgs" 
                                className="ml-4 flex items-center gap-2 px-4 py-1.5 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[10px] font-black uppercase tracking-widest hover:bg-blue-500/20 transition-all"
                            >
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        <div className="space-y-1.5">
                            ...
                            <select 
                                ...
                                className="bg-[#1e293b]/50 border border-white/10 rounded-xl px-4 py-2 text-xs text-white focus:outline-none focus:border-blue-500/50 min-w-[160px]"
                            >
                        ...
                        <button 
                            ...
                            className="mt-5 p-2 rounded-xl bg-white/5 text-slate-400 hover:text-white transition-colors border border-white/5"
                            title="Reset Filters"
                        >
                                                    ...
                                                    >
                                                        <PremiumCard glowColor={(display.status === 'Online' || (display.current_value || display.currentValue) > 0) ? 'emerald' : 'rose'}>
                                                            <div className="flex justify-between items-start mb-6">
                                                                <div className="flex items-center gap-3">
                                                                    <div className={`w-3 h-3 rounded-full ${(display.status === 'Online' || (display.current_value || display.currentValue) > 0) ? 'bg-emerald-500 animate-pulse' : 'bg-rose-500'}`} />
                                                                    <div>
                                                                ...
                                                                <div className="flex gap-2">
                                                                    <button onClick={() => handleDelete(display._id || display.id)} className="p-2 rounded-xl bg-white/5 text-slate-400 hover:text-rose-400 border border-white/5 transition-all">
                                                                        <Icon icon="solar:trash-bin-trash-bold-duotone" />
                                                                    </button>
                                                                </div>
                                                            </div>

                                                            <div className="relative h-32 w-full bg-[#0a0f1e] border-4 border-[#1e293b] rounded-xl overflow-hidden shadow-inner flex flex-col items-center justify-center mb-6">
