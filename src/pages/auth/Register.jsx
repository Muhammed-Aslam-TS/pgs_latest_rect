  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4 relative overflow-hidden">
        <div className="absolute inset-0 z-0">
            ...
            <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-emerald-600/5 rounded-full blur-[140px]" />
        </div>
                ...
                <AnimatePresence>
                    {error && (
                        <motion.div 
                            ...
                            className="mb-6 p-4 rounded-2xl bg-rose-500/10 border border-rose-500/20 flex items-center gap-3 overflow-hidden"
                        >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="space-y-1.5">
                        ...
                        <input 
                            ...
                            className="w-full bg-[#0a0f1e]/40 border border-white/5 rounded-2xl px-5 py-3.5 text-sm text-white focus:outline-none focus:border-emerald-500/50 transition-all"
                        />
                    </div>
                    <div className="space-y-1.5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            ...
                            <input 
                                ...
                                placeholder="••••••••"
                                className="w-full bg-[#0a0f1e]/40 border border-white/5 rounded-2xl px-5 py-3.5 text-sm text-white focus:outline-none focus:border-emerald-500/50 transition-all font-mono"
                            />
                        </div>
                        <div className="space-y-1.5">
                    ...
                    <button 
                        ...
                        className="w-full py-4 mt-4 rounded-2xl bg-gradient-to-r from-emerald-600 to-blue-600 text-white text-xs font-black uppercase tracking-[0.2em] shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
                    >
