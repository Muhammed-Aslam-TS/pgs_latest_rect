    ...
    >
      ...
      {!isFlipped ? (
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          <div className="rounded-xl p-4 bg-white/5 border border-white/5 hover:bg-white/10 transition-all">
            <p className="text-[9px] font-bold uppercase tracking-widest text-slate-500 mb-1">Total Slots</p>
            <span className="text-2xl font-bold text-white">{total_spaces ?? '—'}</span>
          </div>

          <div className="rounded-xl p-4 bg-white/5 border border-white/5 hover:bg-white/10 transition-all">
            <p className="text-[9px] font-bold uppercase tracking-widest text-slate-500 mb-1">Levels</p>
            <span className="text-2xl font-bold text-white">{total_floors ?? '—'}</span>
          </div>

          <div className="rounded-xl p-4 bg-rose-500/5 border border-rose-500/10 hover:bg-rose-500/10 transition-all">
            <p className="text-[9px] font-bold uppercase tracking-widest text-rose-500/70 mb-1">Busy</p>
            <span className="text-2xl font-bold text-rose-400">{occupied ?? '—'}</span>
          </div>

          <div className="rounded-xl p-4 bg-emerald-500/5 border border-emerald-500/10 hover:bg-emerald-500/10 transition-all">
            <p className="text-[9px] font-bold uppercase tracking-widest text-emerald-500/70 mb-1">Ready</p>
