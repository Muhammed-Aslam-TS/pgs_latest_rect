        ...
        <div className="flex flex-col items-center justify-center py-2">
          ...
          <div className="flex gap-3 mt-6 w-full">
            ...
            <div className="flex-1 bg-white/5 rounded p-2 text-center border border-white/5">
              ...
              <p className="text-lg font-bold text-emerald-400">{total_spaces - occupied}</p>
            </div>
          </div>
        </div>
      ) : (
        <div className="grid grid-cols-2 gap-3 mt-4">
          <div className="bg-white/5 p-4 rounded border border-white/5 hover:bg-white/10 transition-all group">
            ...
            <span className="text-xl font-bold text-white block mt-2">{total_spaces}</span>
          </div>
          ...
          <div className="bg-white/5 p-4 rounded border border-white/5 hover:bg-white/10 transition-all group">
            ...
            <span className="text-xl font-bold text-white block mt-2">{total_zones}</span>
          </div>

          <div className="bg-rose-500/5 p-4 rounded border border-rose-500/10 hover:bg-rose-500/10 transition-all">
            <div className="flex items-center gap-2 text-rose-400/70 text-[9px] uppercase font-bold tracking-widest">
              <span>Occupied</span>
            </div>
            <span className="text-xl font-bold text-rose-400 block mt-2">{occupied}</span>
          </div>

          <div className="bg-emerald-500/5 p-4 rounded border border-emerald-500/10 hover:bg-emerald-500/10 transition-all">
            <div className="flex items-center gap-2 text-emerald-400/70 text-[9px] uppercase font-bold tracking-widest">
              <span>Available</span>
            </div>
            <span className="text-xl font-bold text-emerald-400 block mt-2">{total_spaces - occupied}</span>
          </div>
        </div>
      )}
    </div>
