      ...
      <div className="px-4 h-full lg:px-8">
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center gap-6">
            <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded bg-emerald-500/5 border border-emerald-500/10">
...
const SidebarToggle = ({ setSidebarOpen }) => (
  <button
    ...
    className="inline-flex items-center p-2 text-slate-400 hover:text-white hover:bg-white/5 rounded transition-all md:hidden"
  >
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-3 pl-2 pr-1 py-1 rounded bg-white/5 border border-white/5 hover:bg-white/10 transition-all group"
      >
        ...
        <div className="w-8 h-8 rounded bg-gradient-to-tr from-slate-700 to-slate-900 border border-white/10 flex items-center justify-center text-xs font-black text-white shadow-xl group-hover:scale-105 transition-transform">
      ...
      <AnimatePresence>
        {isDropdownOpen && (
          ...
          >
            ...
            <div className="p-2">
              <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded text-xs font-bold text-slate-300 hover:text-white hover:bg-white/5 transition-all">
                <Icon icon="solar:user-circle-bold-duotone" className="text-lg text-blue-400" />
                Profile Settings
              </button>
              <button
                onClick={logout}
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded text-xs font-bold text-rose-400 hover:bg-rose-500/10 transition-all"
              >
