...
const Loader = ({ message = "Initializing Systems...", fullScreen = true }) => {
  return (
    <div 
      className={`flex items-center justify-center z-[9999] overflow-hidden ${
        fullScreen ? "fixed inset-0 bg-[#020617]/80 backdrop-blur-2xl" : "w-full h-full py-20 bg-transparent"
      }`}
    >
      ...
      {fullScreen && (
        <>
          ...
          <motion.div 
            ...
            className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-emerald-600/10 rounded-full blur-[120px]" 
          />
        </>
      )}
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative w-24 h-24 mb-8">
          ...
          <motion.div
            ...
            className="absolute inset-2 border-4 border-emerald-500 rounded-full shadow-[0_0_20px_rgba(16,185,129,0.5)]"
          />
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <motion.div
              ...
              className="w-8 h-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg flex items-center justify-center"
            >
        ...
        <div className="text-center space-y-3">
          ...
          {/* Progress Simulation */}
          <div className="w-64 h-1 bg-white/5 rounded-full overflow-hidden border border-white/5 mx-auto">
            <motion.div
              animate={{ x: [-256, 256] }}
